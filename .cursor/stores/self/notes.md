...
- Leasing ЮЛ click → firm fields + red МОЛ badge (pointerdown fix; was stuck on indiv panel) — see `internal/leasing-mol-badge-fix.md` + `media/leasing-mol-badge-visible.png`
...
- Header + checkout profile menus: Simona 6 labels + CTA copy refresh — `internal/profile-menu-renamed.md` + `media/profile-menu-renamed.png` / `media/profile-cta-text.png`
