...
- Leasing-completed CTA (complete): hide `#aside-leasing-btn` + morph Купи → **КУПИ НА ИЗПЛАЩАНЕ** + `body.is-leasing-ready`; inline JS synced on index+poruchka — see `internal/leasing-completed-cta.md`
